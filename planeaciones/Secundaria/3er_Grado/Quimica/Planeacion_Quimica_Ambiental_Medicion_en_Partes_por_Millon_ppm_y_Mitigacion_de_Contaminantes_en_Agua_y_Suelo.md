---
tags: [iskool, planeacion_nem, segundo_cerebro, campo_saberes_y_pensamiento_cientifico, grado_3er_grado, materia_quimica, fase6_secundaria, programa_sintetico_oficial_2024]
...
1. **¿Por qué una sustancia altamente tóxica (como el plomo, arsénico o pesticidas) puede ser letal incluso en concentraciones invisibles de unas pocas "partes por millón" (ppm)?**

2. **¿Cómo calculamos matemáticamente la concentración en ppm ($\text{ppm} = \frac{\text{mg de soluto}}{\text{kg de disolución}}$ o $\frac{\text{mg}}{\text{L}}$) en una muestra de agua de río o pozo?**

3. **¿Qué es la bioacumulación y biomagnificación de metales pesados en las cadenas tróficas acuáticas que terminan en los peces que consumimos?**

4. **¿Qué procesos químicos sencillos (floculación con sales de aluminio, carbón activado, aireación) permiten reducir los contaminantes en el agua comunitaria?**
...
• Colorante vegetal, 6 vasos de precipitado de 100 ml y goteros.
...
> 📄 **Reporte de Práctica de Laboratorio "Determinación de Concentración en ppm y Purificación de Agua por Floculación y Carbón Activado".**
