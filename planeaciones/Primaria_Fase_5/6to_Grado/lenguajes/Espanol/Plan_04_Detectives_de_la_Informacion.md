...
1. **¿Por qué dos periódicos distintos pueden titular la misma noticia con enfoques completamente opuestos?**

2. **¿Cómo identificamos si una noticia proviene de una agencia verificada, un testigo real o un rumor sin fundamento en redes sociales?**

3. **¿Qué elementos gráficos (titulares alarmistas, imágenes recortadas, colores) usan los medios para influir en nuestras emociones?**

4. **¿Qué responsabilidad ciudadana tenemos antes de compartir una noticia en la era digital?**
...
• Ejemplares impresos y digitales de diferentes periódicos y revistas.
...
**Matriz de Contraste Periodístico y Decálogo del Lector Crítico frente a la Desinformación.**
