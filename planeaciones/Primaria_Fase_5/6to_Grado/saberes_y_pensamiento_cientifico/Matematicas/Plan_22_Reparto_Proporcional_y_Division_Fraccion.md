...
1. **¿Qué significa en la vida real dividir $3/4$ de kilogramo de queso entre 3 personas en partes iguales?**

2. **¿Por qué al dividir una fracción entre un número natural ($3/4 \div 3 = 1/4$ o $2/5 \div 4 = 2/20 = 1/10$) el resultado es una porción más pequeña?**

3. **¿Cómo calculamos el costo unitario si un paquete de 6 libretas cuesta $187.50 pesos en la papelería?**

4. **¿Qué ocurre con el punto decimal en la casita de división cuando dividimos un decimal entre un entero?**
...
1. Taller de Modelado y Algoritmo de División en Parejas:
   • División de fracciones entre enteros:
     $$rac{a}{b} div n = rac{a}{b 	imes n}$$
     Ejemplo: $rac{4}{5} div 2 = rac{4}{10} = rac{2}{5}$ de litro de pintura por pared.
...
• Hojas de problemas de la cooperativa escolar.
...
**Problemario Resuelto "Finanzas de la Cooperativa Escolar: Repartos Fraccionarios y Cocientes Decimales".**
