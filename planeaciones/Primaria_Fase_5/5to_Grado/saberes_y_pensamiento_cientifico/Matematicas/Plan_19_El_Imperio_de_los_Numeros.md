---
tags: [iskool, planeacion_nem, segundo_cerebro, campo_saberes_y_pensamiento_cientifico, grado_5to_grado, materia_matematicas, fase5_primaria]
...
fecha_creacion: "2026-08-18T18:32:32.766Z"
---

# El Imperio de los Números: De las Millonésimas a las Fracciones Equivalentes
...
> **Fase 5 (5º Primaria) - A través de situaciones vinculadas a diferentes contextos ordena, lee, escribe e identifica regularidades en números naturales de hasta nueve cifras. Lee, escribe y ordena números decimales hasta diezmilésimos en notación decimal y letra, y los interpreta en diferentes contextos. Resuelve situaciones problemáticas que implican comparar y ordenar fracciones a partir de construir fracciones equivalentes al multiplicar o dividir al numerador y al denominador por un mismo número. Reconoce, interpreta y utiliza las fracciones 1/2, 1/4, 3/4, 1/5 y 1/8 expresados en notación decimal y viceversa en diferentes contextos.**

---

## ❓ II. Preguntas Detonadoras para el Salón (Conflicto Cognitivo y Apertura)

1. **¿Cómo se lee y escribe la población total de México (129,000,000) o el presupuesto nacional usando el valor posicional de hasta 9 cifras?**

2. **¿Por qué el número decimal $0.75$ es exactamente equivalente a la fracción $3/4$, y $0.125$ equivale a $1/8$?**

3. **¿Cómo transformamos una fracción en otra equivalente multiplicando el numerador y denominador por el mismo factor?**

4. **¿Qué número es mayor: $0.45$ o $0.405$, y cómo nos ayuda la tabla de órdenes decimales (décimos, centésimos, milésimos, diezmilésimos)?**
...
2. Desafíos de Fracciones Equivalentes por Amplificación y Simplificación:
   • Resuelven problemas de reparto de tierras comunales y recetas de cocina: $rac{2}{3} = rac{4}{6} = rac{8}{12}$.
...
• Tiras de papel milimétrico y reglas graduadas.
...
**Bitácora de Retos "El Ábaco de los Millones y la Recta de Fracciones Equivalentes".**
