---
tags: [iskool, ux, ui, diseno-minimalista, frontend, nextjs, tailwindv4, routing]
fecha_creacion: "2026-08-12"
modulo: "Dashboard del Profesor (Teacher Hub) & Enrutamiento App Router"
---

# Rediseño UX/UI: La Regla de los 3 Clics de ISkool y Mapa de Rutas del Hub (`UX_Teacher_Minimalist.md`)
...
## 2. Paradigma de Diseño Minimalista e Intuitivo
...
graph TD
    ...
    C --> C1[Estudio ISkool - Generador de Juegos con IA]
...
| **🎨 Crear Actividad** *(Hero)* | `/teacher/canvas` | `bg-gradient-to-b from-purple-600 via-violet-600 to-indigo-700`, `ring-4 ring-purple-500/20`, insignia animada. | Abre el estudio de creación **Estudio ISkool**. |
