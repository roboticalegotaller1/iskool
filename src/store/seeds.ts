...
export const CAMPUSES_SEED: Campus[] = [
  ...
  },
  {
    ...
    level: 'primaria',
    grades: ['1º Primaria', '2º Primaria', '3º Primaria', '4º Primaria', '5º Primaria', '6º Primaria', '1º Secundaria', '2º Secundaria', '3º Secundaria', '1º Semestre CCH', '2º Semestre CCH', '3º Semestre CCH', '4º Semestre CCH', '5º Semestre CCH', '6º Semestre CCH'],
  ...
  },
  {
    ...
    level: 'primaria',
    grades: ['Kínder 1', 'Kínder 2', 'Kínder 3', '1º Primaria', '2º Primaria', '3º Primaria', '4º Primaria'],
    address: 'Lago Erie #26, Jardines de Morelos Sección Lagos, C.P. 55070, Ecatepec de Morelos, Edomex',
    phone: '55-4440-1009',
    created_at: new Date().toISOString()
  },
  {
    ...
    level: 'primaria',
    grades: ['1º Primaria', '2º Primaria', '3º Primaria', '4º Primaria', '5º Primaria', '6º Primaria', '1º Secundaria', '2º Secundaria', '3º Secundaria'],
    address: 'Av. Insurgentes #5, Lomas de Atzolco, C.P. 55080, Ecatepec de Morelos, Edomex',
    phone: '55-4440-1009',
    created_at: new Date().toISOString()
  },
  {
    ...
    level: 'secundaria',
    grades: ['1º Primaria', '2º Primaria', '3º Primaria', '4º Primaria', '5º Primaria', '6º Primaria', '1º Secundaria', '2º Secundaria', '3º Secundaria', '1º Semestre', '2º Semestre', '3º Semestre', '4º Semestre', '5º Semestre', '6º Semestre'],
    address: 'Obraje s/n esq. Av. Nacional #29, Col. Guadalupe Victoria, C.P. 55010, Ecatepec-Coacalco, Edomex',
    phone: '55-4440-1009',
    created_at: new Date().toISOString()
  },
  {
    ...
    name: 'Sede Digital de Docentes Autónomos',
    level: 'secundaria',
    grades: ['1º Primaria', '2º Primaria', '3º Primaria', '4º Primaria', '5º Primaria', '6º Primaria', '1º Secundaria', '2º Secundaria', '3º Secundaria', '1º Semestre', '2º Semestre', '3º Semestre', '4º Semestre', '5º Semestre', '6º Semestre'],
    address: 'Comunidad Nacional de Docentes Autónomos, México',
    phone: '55-8000-DOCENTE',
    created_at: new Date().toISOString()
  }
];
...
export const DEFAULT_ARTIFACTS_SEED: ShopArtifact[] = [
  {
    id: 'art-hp-potion',
    name: 'Poción de Vigor Intelectual',
    description: 'Brebaje destilado de concentración pura que restaura vitalidad ante retos extenuantes.',
    price: 25,
    icon: 'GlassWater',
    effect: '+50 HP Combate',
    detailedEffect: 'Restaura +50 puntos de salud al avatar durante batallas contra Jefes de Materia.',
    category: 'rpg_combat',
    rarity: 'common',
    mechanic: 'heal_50'
  },
  {
    id: 'art-runic-shield',
    name: 'Escudo Rúnico de Concentración',
    description: 'Barrera arcana que desvía ataques de confusión y reduce el impacto de fallos.',
    price: 35,
    icon: 'Shield',
    effect: 'Mitiga 50% Daño',
    detailedEffect: 'Absorbe el 50% del daño del próximo ataque del Jefe escolar y bloquea distracciones.',
    category: 'rpg_combat',
    rarity: 'rare',
    mechanic: 'shield_50'
  },
  {
    id: 'art-mana-elixir',
    name: 'Elixir de Enfoque Crítico',
    description: 'Esencia cristalina que agudiza la lógica y potencia los ataques científicos.',
    price: 45,
    icon: 'Wine',
    effect: '+40 Daño Lógico',
    detailedEffect: 'Canaliza razonamiento puro para otorgar +40 de daño bonus en tu siguiente turno contra el Jefe.',
    category: 'rpg_combat',
    rarity: 'rare',
    mechanic: 'damage_40'
  },
  {
    id: 'art-phoenix-feather',
    name: 'Pluma de Fénix Escolar',
    description: 'Reliquia milenaria que revive el espíritu del estudiante cuando todo parece perdido.',
    price: 85,
    icon: 'PenTool',
    effect: 'Resurrección 40 HP',
    detailedEffect: 'Si tu salud llega a 0 en una batalla contra el Jefe de Materia, revive inmediatamente con 40 HP.',
    category: 'rpg_combat',
    rarity: 'epic',
    mechanic: 'revive_40'
  },
  {
    id: 'art-chronos-clock',
    name: 'Reloj de Arena de Chronos',
    description: 'Ralentiza el fluir del tiempo para analizar problemas con serenidad.',
    price: 30,
    icon: 'Clock',
    effect: '+45 Segundos',
    detailedEffect: 'Otorga +45 segundos adicionales en retos con cronómetro y pruebas de lectura comprensiva.',
    category: 'academic_challenges',
    rarity: 'common',
    mechanic: 'extra_time_45'
  },
  {
    id: 'art-boots',
    name: 'Botas de Agilidad Escolar',
    description: 'Calzado encantado que permite esquivar trampas y preguntas capciosas.',
    price: 20,
    icon: 'Footprints',
    effect: 'Esquiva Capciosa',
    detailedEffect: 'Permite saltar una pregunta dudosa en un reto sin penalizar el porcentaje final.',
    category: 'academic_challenges',
    rarity: 'common',
    mechanic: 'skip_question'
  },
  {
    id: 'art-ai-lens',
    name: 'Monóculo del Asistente Pedagógico IA',
    description: 'Lente de enfoque pedagógico que analiza el reactivo y resalta el camino correcto.',
    price: 40,
    icon: 'Sparkles',
    effect: 'Pista Inteligente',
    detailedEffect: 'Descarta opciones incorrectas y entrega una pista reflexiva de la Inteligencia Artificial Pedagógica.',
    category: 'academic_challenges',
    rarity: 'rare',
    mechanic: 'ai_hint'
  },
  {
    id: 'art-exam-retry',
    name: 'Cristal de Segunda Oportunidad',
    description: 'Gema resplandeciente que concede un nuevo intento sin mácula en el historial.',
    price: 60,
    icon: 'Heart',
    effect: '+1 Reintento Examen',
    detailedEffect: 'Otorga una oportunidad extra para volver a presentar un examen reprobado y subir tu calificación.',
    category: 'academic_challenges',
    rarity: 'epic',
    mechanic: 'extra_attempt'
  },
  {
    id: 'art-streak-freeze',
    name: 'Amuleto de Fuego Fatuo (Racha)',
    description: 'Guarda la llama de tu racha intacta ante imprevistos o jornadas de descanso.',
    price: 50,
    icon: 'Gem',
    effect: 'Protector de Racha',
    detailedEffect: 'Protege tu racha de días consecutivos si por causa de fuerza mayor o descanso no te conectas un día.',
    category: 'progression_economy',
    rarity: 'rare',
    mechanic: 'streak_freeze'
  },
  {
    id: 'art-double-xp-scroll',
    name: 'Pergamino del Doble Saber',
    description: 'Manuscrito antiguo con fórmulas que multiplican el aprendizaje adquirido.',
    price: 75,
    icon: 'Scroll',
    effect: '2x Multiplicador XP',
    detailedEffect: 'Duplica la experiencia obtenida en tu próxima misión o proyecto interactivo del Estudio ISkool.',
    category: 'progression_economy',
    rarity: 'epic',
    mechanic: 'double_xp'
  },
  {
    id: 'art-fortune-talisman',
    name: 'Talismán de la Fortuna Académica',
    description: 'Amuleto áureo que bendice las recompensas de tus próximas faenas escolares.',
    price: 65,
    icon: 'Coins',
    effect: '+25% Monedas Extra',
    detailedEffect: 'Genera un 25% más de monedas escolares en tus siguientes 3 misiones o retos completados.',
    category: 'progression_economy',
    rarity: 'rare',
    mechanic: 'coins_boost'
  },
  {
    id: 'art-companion-nectar',
    name: 'Néctar del Santuario Espiritual',
    description: 'Gotas de manantial bendito que revitalizan a tu mascota o compañero espiritual.',
    price: 20,
    icon: 'GlassWater',
    effect: '100% Vitalidad Mascota',
    detailedEffect: 'Restaura por completo la energía, hambre y felicidad de tu compañero o mascota mágica en el Santuario.',
    category: 'sanctuary_companions',
    rarity: 'common',
    mechanic: 'companion_restore'
  },
  {
    id: 'art-shield',
    name: 'Escudo Protector de Promedios',
    description: 'Armadura conceptual que resguarda tu calificación ante tropezones académicos.',
    price: 40,
    icon: 'Shield',
    effect: 'Respaldo Escolar',
    detailedEffect: 'Evita penalizaciones de créditos y protege tu promedio trimestral ante fallos eventuales.',
    category: 'progression_economy',
    rarity: 'rare',
    mechanic: 'gpa_shield'
  },
  {
    id: 'art-scholar-crown',
    name: 'Corona del Erudito de Oro',
    description: 'Diadema resplandeciente forjada con los cuatro campos formativos de la Nueva Escuela Mexicana.',
    price: 150,
    icon: 'Crown',
    effect: 'Halo Dorado Avatar',
    detailedEffect: 'Corona ceremonial que proyecta un halo místico de oro sobre tu avatar en aulas y cuadros de honor.',
    category: 'avatar_cosmetics',
    rarity: 'epic',
    mechanic: 'cosmetic_golden_halo'
  },
  {
    id: 'art-astral-aura',
    name: 'Aura Astral del Conocimiento',
    description: 'Manifestación visual de sabiduría cósmica con anillos orbitales y destellos estelares.',
    price: 220,
    icon: 'Wand2',
    effect: 'Aura Cósmica Orbital',
    detailedEffect: 'Emanación de constelaciones celestiales y partículas orbitales visibles en tu aula y perfil.',
    category: 'avatar_cosmetics',
    rarity: 'legendary',
    mechanic: 'cosmetic_astral_aura'
  },
  {
    id: 'art-master-cape',
    name: 'Manto del Gran Maestro Escolar',
    description: 'Capa solemne bordada con hilos de plata y sellos de excelencia institucional.',
    price: 250,
    icon: 'Shirt',
    effect: 'Capa Ceremonial & Karma',
    detailedEffect: 'Prenda mística de gala bordada con sellos institucionales. Concede distinción en el Cuadro de Honor Escolar.',
    category: 'avatar_cosmetics',
    rarity: 'legendary',
    mechanic: 'cosmetic_master_cape'
  }
];
...
export const SUBJECTS_SEED: Subject[] = [
  ...
  // ==========================================
  // MATERIAS INSTITUTO BILINGÜE IBIME
  // ==========================================
  // Curriculares Primaria Bilingüe IBIME (SEP NEM 2024 & Cambridge)
  ...
  // Curriculares Secundaria Trilingüe IBIME
  ...
  // Curriculares Bachillerato UNAM CCH (Clave UNAM 7998)
  ...
  // Optativas / Talleres Institucionales IBIME
  { 
    id: 'sub-ibime-rob-steam', 
    school_id: 'sch-ibime', 
    level_grade_id: 'all', 
    name: 'Taller de Robótica STEAM & Mecatrónica IBIME', 
    sep_code: 'IB-OPT-ROB', 
    category: 'optativa', 
    workshop_category: 'tecnologico',
    is_elective: true, 
    instructor_name: 'Ing. Sofía Cordero / Prof. Alejandro Mendoza',
    campus_name: 'Todos los Planteles IBIME',
    schedule: 'Martes y Jueves 16:00 - 17:30',
    description: 'Taller representativo para certámenes de robótica y mecatrónica escolar.',
    assigned_group_ids: ['grp-ibime-m-5a', 'grp-ibime-m-sec1', 'grp-ibime-sc-2a', 'grp-ibime-c-4a'],
    created_at: new Date().toISOString()
  },
  { 
    id: 'sub-ibime-liderazgo', 
    school_id: 'sch-ibime', 
    level_grade_id: 'all', 
    name: 'Formación Humana, Liderazgo & Retórica IBIME', 
    sep_code: 'IB-OPT-LID', 
    category: 'optativa', 
    workshop_category: 'academico',
    is_elective: true, 
    instructor_name: 'Lic. Elizabeth Hernández Ramos',
    campus_name: 'Todos los Planteles IBIME',
    schedule: 'Viernes 15:00 - 16:30',
    description: 'Programa sello institucional IBIME para el desarrollo de competencias oratorias y éticas.',
    assigned_group_ids: ['grp-ibime-m-5a', 'grp-ibime-l-3a', 'grp-ibime-sc-2a', 'grp-ibime-c-4a'],
    created_at: new Date().toISOString()
  },
...
export const STUDENTS_LIST_SEED: UserProfile[] = [
  { id: 'std-pb', first_name: 'Santi', last_name: 'Gómez Pérez', role: 'student', email: 'santi.gómez@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.929Z', updated_at: '2026-07-08T11:50:26.930Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380b02', first_name: 'Sofía', last_name: 'Castro Ruiz', role: 'student', email: 'sofía.castro1@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380b03', first_name: 'Mateo', last_name: 'Ortiz Medina', role: 'student', email: 'mateo.ortiz2@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380b04', first_name: 'Valentina', last_name: 'Hernández Silva', role: 'student', email: 'valentina.hernández3@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380b05', first_name: 'Sebastián', last_name: 'Flores Torres', role: 'student', email: 'sebastián.flores4@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380b06', first_name: 'Camila', last_name: 'Jiménez Lara', role: 'student', email: 'camila.jiménez5@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380b07', first_name: 'Diego', last_name: 'Vargas Ríos', role: 'student', email: 'diego.vargas6@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380b08', first_name: 'Natalia', last_name: 'Montes Delgado', role: 'student', email: 'natalia.montes7@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380b09', first_name: 'Nicolás', last_name: 'Soto Luna', role: 'student', email: 'nicolás.soto8@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380b10', first_name: 'Regina', last_name: 'Cruz Peña', role: 'student', email: 'regina.cruz9@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'std-pa', first_name: 'Lucas', last_name: 'Skywalker Organa', role: 'student', email: 'lucas.skywalker@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a02', first_name: 'Juan', last_name: 'Pérez López', role: 'student', email: 'juan.pérez1@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a03', first_name: 'Ana', last_name: 'Gómez Castro', role: 'student', email: 'ana.gómez2@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a04', first_name: 'Carlos', last_name: 'Ruiz Medina', role: 'student', email: 'carlos.ruiz3@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a05', first_name: 'María', last_name: 'Fernández Soto', role: 'student', email: 'maría.fernández4@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a06', first_name: 'Luis', last_name: 'Ortiz Vargas', role: 'student', email: 'luis.ortiz5@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a07', first_name: 'Andrea', last_name: 'Flores Jiménez', role: 'student', email: 'andrea.flores6@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a08', first_name: 'Daniel', last_name: 'Vargas Montes', role: 'student', email: 'daniel.vargas7@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a09', first_name: 'Isabella', last_name: 'Cruz Torres', role: 'student', email: 'isabella.cruz8@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.931Z', updated_at: '2026-07-08T11:50:26.931Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a10', first_name: 'Mateo', last_name: 'Díaz Luna', role: 'student', email: 'mateo.díaz9@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'std-sec', first_name: 'Elena', last_name: 'Rostova Bolonskaya', role: 'student', email: 'elena.rostova@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380c02', first_name: 'Alejandro', last_name: 'Castro Ruiz', role: 'student', email: 'alejandro.castro1@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380c03', first_name: 'Sofía', last_name: 'Ortiz Lara', role: 'student', email: 'sofía.ortiz2@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380c04', first_name: 'Miguel', last_name: 'Hernández Silva', role: 'student', email: 'miguel.hernández3@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380c05', first_name: 'Valentina', last_name: 'Flores Torres', role: 'student', email: 'valentina.flores4@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380c06', first_name: 'Diego', last_name: 'Jiménez Ríos', role: 'student', email: 'diego.jiménez5@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380c07', first_name: 'Camila', last_name: 'Vargas Montes', role: 'student', email: 'camila.vargas6@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380c08', first_name: 'Leonardo', last_name: 'Soto Luna', role: 'student', email: 'leonardo.soto7@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380c09', first_name: 'Natalia', last_name: 'Cruz Peña', role: 'student', email: 'natalia.cruz8@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380c10', first_name: 'Nicolás', last_name: 'Torres Cruz', role: 'student', email: 'nicolás.torres9@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
  { id: 'std-prep', first_name: 'Mateo', last_name: 'Díaz Hernández', role: 'student', email: 'mateo.díaz@iskool.edu.mx', school_id: 'sch-test-case', created_at: '2026-07-08T11:50:26.932Z', updated_at: '2026-07-08T11:50:26.932Z' },
...
export const GROUPS_SEED: Group[] = [
  ...
  // Grupos Instituto Bilingüe IBIME (4 Planteles)
  // Campus Montes (Sede Matriz & CCH)
  { id: 'grp-ibime-m-1a', school_id: 'sch-ibime', campus_id: 'cmp-ibime-montes', campus_name: 'Campus Montes (Sede Matriz & CCH)', level_grade_id: 'primaria-1º', level: 'primaria', grade: '1º', academic_year_id: 'ay-25-26', name: '1ºA Primaria Montes', student_ids: [], created_at: new Date().toISOString() },
  { id: 'grp-ibime-m-5a', school_id: 'sch-ibime', campus_id: 'cmp-ibime-montes', campus_name: 'Campus Montes (Sede Matriz & CCH)', level_grade_id: 'primaria-5º', level: 'primaria', grade: '5º', academic_year_id: 'ay-25-26', name: '5ºA Primaria Bilingüe Montes', student_ids: ['std-ibime-montes-01'], created_at: new Date().toISOString() },
  { id: 'grp-ibime-m-sec1', school_id: 'sch-ibime', campus_id: 'cmp-ibime-montes', campus_name: 'Campus Montes (Sede Matriz & CCH)', level_grade_id: 'secundaria-1º', level: 'secundaria', grade: '1º', academic_year_id: 'ay-25-26', name: '1ºA Secundaria Montes', student_ids: [], created_at: new Date().toISOString() },
  { id: 'grp-ibime-m-cch1', school_id: 'sch-ibime', campus_id: 'cmp-ibime-montes', campus_name: 'Campus Montes (Sede Matriz & CCH)', level_grade_id: 'preparatoria-1º', level: 'preparatoria', grade: '1º Semestre', academic_year_id: 'ay-25-26', name: '1º Semestre CCH UNAM Montes', student_ids: [], created_at: new Date().toISOString() },

  // Campus Lagos (Fundador 2004 - Kínder y Primaria)
  { id: 'grp-ibime-l-k1', school_id: 'sch-ibime', campus_id: 'cmp-ibime-lagos', campus_name: 'Campus Lagos (Fundador 2004)', level_grade_id: 'preescolar-1º', level: 'preescolar', grade: 'Kínder 1', academic_year_id: 'ay-25-26', name: 'Kínder 1 Lagos', student_ids: [], created_at: new Date().toISOString() },
  { id: 'grp-ibime-l-k3', school_id: 'sch-ibime', campus_id: 'cmp-ibime-lagos', campus_name: 'Campus Lagos (Fundador 2004)', level_grade_id: 'preescolar-3º', level: 'preescolar', grade: 'Kínder 3', academic_year_id: 'ay-25-26', name: 'Kínder 3 Bilingüe Lagos', student_ids: [], created_at: new Date().toISOString() },
  { id: 'grp-ibime-l-3a', school_id: 'sch-ibime', campus_id: 'cmp-ibime-lagos', campus_name: 'Campus Lagos (Fundador 2004)', level_grade_id: 'primaria-3º', level: 'primaria', grade: '3º', academic_year_id: 'ay-25-26', name: '3ºA Primaria Lagos', student_ids: ['std-ibime-lagos-01'], created_at: new Date().toISOString() },

  // Campus San Cristóbal (Ecatepec Centro - Cambridge English)
  { id: 'grp-ibime-sc-1a', school_id: 'sch-ibime', campus_id: 'cmp-ibime-sancristobal', campus_name: 'Campus San Cristóbal (Ecatepec Centro)', level_grade_id: 'primaria-1º', level: 'primaria', grade: '1º', academic_year_id: 'ay-25-26', name: '1ºA Primaria Bilingüe San Cristóbal', student_ids: [], created_at: new Date().toISOString() },
  { id: 'grp-ibime-sc-2a', school_id: 'sch-ibime', campus_id: 'cmp-ibime-sancristobal', campus_name: 'Campus San Cristóbal (Ecatepec Centro)', level_grade_id: 'secundaria-2º', level: 'secundaria', grade: '2º', academic_year_id: 'ay-25-26', name: '2ºA Secundaria San Cristóbal', student_ids: ['std-ibime-san-01'], created_at: new Date().toISOString() },
  { id: 'grp-ibime-sc-3a', school_id: 'sch-ibime', campus_id: 'cmp-ibime-sancristobal', campus_name: 'Campus San Cristóbal (Ecatepec Centro)', level_grade_id: 'secundaria-3º', level: 'secundaria', grade: '3º', academic_year_id: 'ay-25-26', name: '3ºA Secundaria San Cristóbal', student_ids: [], created_at: new Date().toISOString() },

  // Campus Coacalco (Metropolitano - Secundaria y CCH)
  { id: 'grp-ibime-c-1a', school_id: 'sch-ibime', campus_id: 'cmp-ibime-coacalco', campus_name: 'Campus Coacalco (Metropolitano)', level_grade_id: 'secundaria-1º', level: 'secundaria', grade: '1º', academic_year_id: 'ay-25-26', name: '1ºA Secundaria Coacalco', student_ids: [], created_at: new Date().toISOString() },
  { id: 'grp-ibime-c-4a', school_id: 'sch-ibime', campus_id: 'cmp-ibime-coacalco', campus_name: 'Campus Coacalco (Metropolitano)', level_grade_id: 'preparatoria-4º', level: 'preparatoria', grade: '4º Semestre', academic_year_id: 'ay-25-26', name: '4º Semestre CCH UNAM Coacalco', student_ids: ['std-ibime-coac-01'], created_at: new Date().toISOString() },
  ...
  // Grupos Autónomos de Profesores Independientes
  { id: 'grp-indep-gab-1', school_id: 'sch-profesores-independientes', teacher_id: 'usr-indep-1', campus_id: 'cmp-indep-main', campus_name: 'Sede Digital de Docentes Autónomos', level_grade_id: 'secundaria-3º', level: 'secundaria', grade: '3º', academic_year_id: 'ay-25-26', name: '3ºA Física Avanzada & Ciencias', student_ids: ['std-indep-gab-01', 'std-indep-gab-02', 'std-indep-gab-03'], created_at: new Date().toISOString() },
  { id: 'grp-indep-gab-2', school_id: 'sch-profesores-independientes', teacher_id: 'usr-indep-1', campus_id: 'cmp-indep-main', campus_name: 'Sede Digital de Docentes Autónomos', level_grade_id: 'secundaria-2º', level: 'secundaria', grade: '2º', academic_year_id: 'ay-25-26', name: '2ºB Ciencias Naturales', student_ids: ['std-indep-gab-04', 'std-indep-gab-05'], created_at: new Date().toISOString() },
  { id: 'grp-indep-sof-1', school_id: 'sch-profesores-independientes', teacher_id: 'usr-indep-2', campus_id: 'cmp-indep-main', campus_name: 'Sede Digital de Docentes Autónomos', level_grade_id: 'secundaria-1º', level: 'secundaria', grade: '1º', academic_year_id: 'ay-25-26', name: '1ºA Historia Universal & Crítica', student_ids: ['std-indep-sof-01', 'std-indep-sof-02', 'std-indep-sof-03'], created_at: new Date().toISOString() }
];
...
export const DETAILED_STUDENTS_SEED: DetailedStudent[] = [
  ...
  },
  {
    ...
    phone: '555-123-2000',
    email: 'lucas.hernandez@sandbox.iskool.edu.mx',
  ...
  },
  {
    ...
    phone: '555-123-3000',
    email: 'mateo.ortiz@sandbox.iskool.edu.mx',
  ...
  },
  {
    ...
    curp: 'MOPI150814HDFRL01',
    enrollment_id: 'IBI-2026-MNT-0514',
    gender: 'Masculino',
    shift: 'matutino',
    status: 'activo',
    previous_school: 'Jardín de Niños IBIME Lagos',
    photo_url: '/images/students/c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a01.png',
    address: 'Paseo de las Aves 124, Jardines de Morelos Secc. Montes, Ecatepec, Edomex',
    phone: '55-4440-1009',
    email: 'iker.morales@ibime.edu.mx',
    father_name: 'Fernando Morales Soto',
    mother_name: 'Lucía Peña Aguilar',
    tutor_name: 'Fernando Morales Soto',
    emergency_contact_name: 'Lucía Peña Aguilar',
    emergency_contact_phone: '55-4440-1009',
    blood_type: 'O+',
    medical_notes: 'Sin alergias médicas reportadas. Esquema de vacunación completo.',
    academic_notes: 'Excelente desempeño en Matemáticas y Robótica STEAM IBIME. Certificación Cambridge Starters aprobada con mérito.',
    level: 'primaria',
    grade: '5º Primaria',
    group_id: 'grp-ibime-m-5a',
  ...
  },
  {
    ...
    curp: 'CARX170322MDFSL02',
    enrollment_id: 'IBI-2026-LGS-0322',
    gender: 'Femenino',
    shift: 'matutino',
    status: 'activo',
    previous_school: 'Kínder IBIME Lagos',
    photo_url: '/images/students/c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a02.png',
    address: 'Lago Hurón 45, Jardines de Morelos Secc. Lagos, Ecatepec, Edomex',
    phone: '55-4440-1009',
    email: 'ximena.castillo@ibime.edu.mx',
    father_name: 'Arturo Castillo Gómez',
    mother_name: 'Andrea Ruiz Salgado',
    tutor_name: 'Andrea Ruiz Salgado',
    emergency_contact_name: 'Andrea Ruiz Salgado',
    emergency_contact_phone: '55-4440-1009',
    blood_type: 'A+',
    medical_notes: 'Alergia estacional leve al polen primaveral controlada con antihistamínico.',
    academic_notes: 'Destacada participación en el Programa Bilingüe y proyectos comunitarios NEM.',
    level: 'primaria',
    grade: '3º Primaria',
    group_id: 'grp-ibime-l-3a',
  ...
  },
  {
    ...
    first_name: 'Mateo',
    second_name: 'Emiliano',
    last_name_1: 'Navas',
    last_name_2: 'Mendoza',
    birth_date: '2012-11-05',
    curp: 'NAMM121105HDFVZ03',
    enrollment_id: 'IBI-2026-SCR-0211',
    gender: 'Masculino',
    shift: 'matutino',
    status: 'activo',
    previous_school: 'Primaria IBIME Montes',
    photo_url: '/images/students/c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a03.png',
    address: 'Av. Insurgentes 88, Col. Lomas de Atzolco, Ecatepec de Morelos, Edomex',
    phone: '55-4440-1009',
    email: 'mateo.navas@ibime.edu.mx',
    father_name: 'Carlos Navas Fuentes',
    mother_name: 'Mariana Mendoza Vaca',
    tutor_name: 'Carlos Navas Fuentes',
    emergency_contact_name: 'Mariana Mendoza Vaca',
    emergency_contact_phone: '55-4440-1009',
    blood_type: 'B+',
    medical_notes: 'Sin antecedentes clínicos de riesgo.',
    academic_notes: 'Capitán de debate bilingüe y candidato a Certificación Cambridge KET.',
    level: 'secundaria',
    grade: '2º Secundaria',
    group_id: 'grp-ibime-sc-2a',
    scholarship_percentage: 20,
    scholarship_type: 'academica',
    scholarship_notes: 'Beca de Mérito Académico Secundaria IBIME.',
    pending_payments: [],
    behavior_reports: [],
    teacher_notes: []
  },
  {
    ...
    curp: 'ALCR090618MDFRN04',
    enrollment_id: 'IBI-2026-COA-0418',
    gender: 'Femenino',
    shift: 'matutino',
    status: 'activo',
    previous_school: 'Secundaria IBIME Coacalco',
    photo_url: '/images/students/c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a04.png',
    address: 'Vía Morelos Km 21, Col. Guadalupe Victoria, Ecatepec-Coacalco, Edomex',
    phone: '55-4440-1009',
    email: 'regina.albarran@ibime.edu.mx',
    father_name: 'Manuel Albarrán Pineda',
    mother_name: 'Sofía Cruz Del Moral',
    tutor_name: 'Manuel Albarrán Pineda',
    emergency_contact_name: 'Sofía Cruz Del Moral',
    emergency_contact_phone: '55-4440-1009',
    blood_type: 'O+',
    medical_notes: 'Sin alergias médicas reportadas.',
    academic_notes: 'Alumna destacada en Bachillerato Incorporado CCH-UNAM. Alto promedio en Ciencias Experimentales e Inglés FCE.',
    level: 'preparatoria',
    grade: '4º Semestre CCH',
    group_id: 'grp-ibime-c-4a',
    scholarship_percentage: 25,
    scholarship_type: 'academica',
    scholarship_notes: 'Beca de Excelencia Propedéutica CCH UNAM IBIME.',
    pending_payments: [],
    behavior_reports: [],
    teacher_notes: []
  },
  {
    ...
    curp: 'VAFL130410HDFRNN05',
    enrollment_id: 'IBI-2026-COA-0410',
    gender: 'Masculino',
    shift: 'matutino',
    status: 'activo',
    previous_school: 'Primaria IBIME San Cristóbal',
    photo_url: '/images/students/c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a05.png',
    address: 'Av. Nacional 45, Col. Guadalupe Victoria, Ecatepec-Coacalco, Edomex',
    phone: '55-4440-1009',
    email: 'leonardo.varela@ibime.edu.mx',
    father_name: 'Daniel Varela Luna',
    mother_name: 'Karla Fuentes Romero',
    tutor_name: 'Daniel Varela Luna',
    emergency_contact_name: 'Karla Fuentes Romero',
    emergency_contact_phone: '55-4440-1009',
    blood_type: 'O+',
    medical_notes: 'Alergia alimentaria leve a los frutos secos (nueces y cacahuates).',
    academic_notes: 'Buen desempeño en Taller de Robótica STEAM IBIME.',
    level: 'secundaria',
    grade: '1º Secundaria',
    group_id: 'grp-ibime-c-1a',
    scholarship_percentage: 0,
    scholarship_type: 'ninguna',
    pending_payments: ['Colegiatura de Agosto 2026 (Extemporánea) - $4,680.00 MXN (Vencida)'],
    behavior_reports: [],
    teacher_notes: []
  },
  {
    ...
    curp: 'HECC190912MDFRL06',
    enrollment_id: 'IBI-2026-MNT-0912',
    gender: 'Femenino',
    shift: 'matutino',
    status: 'activo',
    previous_school: 'Kínder IBIME Lagos',
    photo_url: '/images/students/c00a0eeb-9c0b-4ef8-bb6d-6bb9bd380a06.png',
    address: 'Av. Jardines de Morelos 89, Secc. Montes, Ecatepec, Edomex',
    phone: '55-4440-1009',
    email: 'camila.herrera@ibime.edu.mx',
    father_name: 'Rodrigo Herrera Galindo',
    mother_name: 'Paola Cruz Vargas',
    tutor_name: 'Rodrigo Herrera Galindo',
    emergency_contact_name: 'Paola Cruz Vargas',
    emergency_contact_phone: '55-4440-1009',
    blood_type: 'A+',
    medical_notes: 'Sin alergias ni restricciones físicas.',
    academic_notes: 'Excelente adaptación al primer grado de Primaria Bilingüe IBIME y desarrollo lector.',
    level: 'primaria',
    grade: '1º Primaria',
    group_id: 'grp-ibime-m-1a',
    scholarship_percentage: 10,
    scholarship_type: 'academica',
    scholarship_notes: 'Beca de Continuidad Familiar IBIME Lagos-Montes.',
    pending_payments: [],
    behavior_reports: [],
    teacher_notes: []
  },
  // Alumnos de Profesores Independientes (Solo Ruleta, Asistencia, Calificaciones, Planeaciones - Sin sección RPG)
  {
    id: 'std-indep-gab-01',
    first_name: 'Emilio',
    last_name_1: 'Carrillo',
    last_name_2: 'Soto',
    birth_date: '2011-03-14',
    curp: 'CASE110314HDFRLN01',
    enrollment_id: 'IND-GAB-001',
    gender: 'Masculino',
    shift: 'vespertino',
    status: 'activo',
    photo_url: '/images/students/default.png',
    email: 'emilio.carrillo@independientes.iskool.edu.mx',
    tutor_name: 'Mauricio Carrillo',
    emergency_contact_phone: '55-1234-5678',
    level: 'secundaria',
    grade: '3º',
    group_id: 'grp-indep-gab-1',
    school_id: 'sch-profesores-independientes',
    teacher_id: 'usr-indep-1',
  ...
  },
  {
    id: 'std-indep-gab-02',
    first_name: 'Valeria',
    last_name_1: 'Maldonado',
    last_name_2: 'Ríos',
    birth_date: '2011-07-22',
    curp: 'MARV110722MDFLN02',
    enrollment_id: 'IND-GAB-002',
    gender: 'Femenino',
    shift: 'vespertino',
    status: 'activo',
    photo_url: '/images/students/default.png',
    email: 'valeria.maldonado@independientes.iskool.edu.mx',
    tutor_name: 'Patricia Ríos',
    emergency_contact_phone: '55-2345-6789',
    level: 'secundaria',
    grade: '3º',
    group_id: 'grp-indep-gab-1',
    school_id: 'sch-profesores-independientes',
  ...
  },
  {
    ...
    curp: 'PANL111005HDFRV03',
    enrollment_id: 'IND-GAB-003',
    gender: 'Masculino',
    shift: 'vespertino',
    status: 'activo',
    photo_url: '/images/students/default.png',
    email: 'leonardo.paz@independientes.iskool.edu.mx',
    tutor_name: 'Esteban Paz',
    emergency_contact_phone: '55-3456-7890',
    level: 'secundaria',
    grade: '3º',
    group_id: 'grp-indep-gab-1',
    school_id: 'sch-profesores-independientes',
  ...
  },
  {
    ...
    curp: 'GUVR120218MDFNZ04',
    enrollment_id: 'IND-GAB-004',
    gender: 'Femenino',
    shift: 'matutino',
    status: 'activo',
    photo_url: '/images/students/default.png',
    email: 'renata.guzman@independientes.iskool.edu.mx',
    tutor_name: 'Gabriela Vega',
    emergency_contact_phone: '55-4567-8901',
    level: 'secundaria',
    grade: '2º',
    group_id: 'grp-indep-gab-2',
    school_id: 'sch-profesores-independientes',
    teacher_id: 'usr-indep-1',
    gamification_enabled: false,
    campus_name: 'Sede Digital de Docentes Autónomos',
  ...
  },
  {
    id: 'std-indep-gab-05',
    first_name: 'Mateo',
    last_name_1: 'Villalobos',
    last_name_2: 'Cruz',
    birth_date: '2012-08-30',
    curp: 'VICM120830HDFLR05',
    enrollment_id: 'IND-GAB-005',
    gender: 'Masculino',
    shift: 'matutino',
    status: 'activo',
    photo_url: '/images/students/default.png',
    email: 'mateo.villalobos@independientes.iskool.edu.mx',
    tutor_name: 'Rodrigo Villalobos',
    emergency_contact_phone: '55-5678-9012',
    level: 'secundaria',
    grade: '2º',
    group_id: 'grp-indep-gab-2',
    school_id: 'sch-profesores-independientes',
  ...
  },
  {
    ...
    curp: 'OEBC130412MDFRT01',
    enrollment_id: 'IND-SOF-001',
    gender: 'Femenino',
    shift: 'matutino',
    status: 'activo',
    photo_url: '/images/students/default.png',
    email: 'camila.ortega@independientes.iskool.edu.mx',
    tutor_name: 'Lucía Blanco',
    emergency_contact_phone: '55-6789-0123',
    level: 'secundaria',
    grade: '1º',
    group_id: 'grp-indep-sof-1',
    school_id: 'sch-profesores-independientes',
    teacher_id: 'usr-indep-2',
    gamification_enabled: false,
    campus_name: 'Sede Digital de Docentes Autónomos',
    pending_payments: [],
    behavior_reports: [],
  ...
  },
  {
    id: 'std-indep-sof-02',
    first_name: 'Diego',
    last_name_1: 'Santillán',
    last_name_2: 'Lara',
    birth_date: '2013-09-09',
    curp: 'SALD130909HDFRN02',
    enrollment_id: 'IND-SOF-002',
    gender: 'Masculino',
    shift: 'matutino',
    status: 'activo',
    photo_url: '/images/students/default.png',
    email: 'diego.santillan@independientes.iskool.edu.mx',
    tutor_name: 'Ignacio Santillán',
    emergency_contact_phone: '55-7890-1234',
    level: 'secundaria',
    grade: '1º',
    group_id: 'grp-indep-sof-1',
    school_id: 'sch-profesores-independientes',
  ...
  },
  {
    ...
    last_name_2: 'Mora',
    birth_date: '2013-11-25',
    curp: 'CAMX131125MDFRR03',
    enrollment_id: 'IND-SOF-003',
    gender: 'Femenino',
    shift: 'matutino',
    status: 'activo',
    photo_url: '/images/students/default.png',
    email: 'ximena.cardenas@independientes.iskool.edu.mx',
    tutor_name: 'Verónica Mora',
    emergency_contact_phone: '55-8901-2345',
    level: 'secundaria',
    grade: '1º',
    group_id: 'grp-indep-sof-1',
    school_id: 'sch-profesores-independientes',
...
export const TEACHERS_LIST_SEED: UserProfile[] = [
  ...
  },
  {
    ...
    assigned_groups: ['1ºA Primaria Demo'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
  {
  ...
  // ==========================================
  // PROFESORES INSTITUTO BILINGÜE IBIME
  // ==========================================
  {
  ...
  {
    id: 'usr-teacher-ibime-5',
    first_name: 'Carlos Alberto',
    last_name: 'Reyes Gutiérrez',
    role: 'teacher',
    school_id: 'sch-ibime',
    email: 'carlos.reyes@ibime.edu.mx',
    birth_date: '1987-01-15',
    age: 39,
    campus_id: 'cmp-ibime-montes',
    campus_name: 'Campus Montes (Sede Matriz & CCH)',
    ai_tokens_consumed: 18500,
    is_blocked: false,
    temporary_password: 'IBI2026',
    assigned_subjects: ['De lo Humano y lo Comunitario (Formación en Valores)', 'Entrenamiento Deportivo Inter-Planteles'],
    assigned_groups: ['1ºA Secundaria Montes', '5ºA Primaria Bilingüe Montes'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
  {
    id: 'usr-teacher-ibime-6',
    first_name: 'Lucía',
    last_name: 'Domínguez Pineda',
    role: 'teacher',
    school_id: 'sch-ibime',
    email: 'lucia.dominguez@ibime.edu.mx',
    birth_date: '1985-10-05',
    age: 40,
    campus_id: 'cmp-ibime-sancristobal',
    campus_name: 'Campus San Cristóbal (Ecatepec Centro)',
    ai_tokens_consumed: 34200,
    is_blocked: false,
    temporary_password: 'IBI2026',
    assigned_subjects: ['Lengua Materna (Español Avanzado)', 'Taller de Lectura, Redacción e Inv. Documental (TLRIID CCH)'],
    assigned_groups: ['2ºA Secundaria San Cristóbal', '1ºA Primaria Bilingüe San Cristóbal'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
  // Docentes Autónomos de Profesores Independientes
  {
    id: 'usr-indep-1',
    first_name: 'Gabriel',
    last_name: 'Montes (Independiente)',
    role: 'teacher',
    school_id: 'sch-profesores-independientes',
    is_independent_teacher: true,
    specialty: 'Física y Ciencias Experimentales',
    bio: 'Docente autónomo enfocado en experimentos prácticos, física cuántica divulgativa y astronomía.',
    token_quota: 250000,
    ai_tokens_consumed: 62400,
    ...
    campus_name: 'Sede Digital de Docentes Autónomos',
    is_blocked: false,
    temporary_password: 'GAB2026',
    assigned_subjects: ['Física', 'Ciencias Naturales'],
    assigned_groups: ['3ºA Física Avanzada & Ciencias', '2ºB Ciencias Naturales'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  },
  {
    id: 'usr-indep-2',
    first_name: 'Sofía',
    last_name: 'Albarrán (Independiente)',
    role: 'teacher',
    school_id: 'sch-profesores-independientes',
    is_independent_teacher: true,
    specialty: 'Historia y Literatura Universal',
    bio: 'Investigadora y docente independiente especialista en fuentes primarias, pensamiento crítico y creación de planeaciones NEM.',
    token_quota: 300000,
    ai_tokens_consumed: 62100,
    ...
    campus_name: 'Sede Digital de Docentes Autónomos',
    is_blocked: false,
    temporary_password: 'SOF2026',
    assigned_subjects: ['Historia Universal', 'Lenguaje y Comunicación'],
    assigned_groups: ['1ºA Historia Universal & Crítica'],
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString()
  }
];
...
export const TUITION_PRICINGS_SEED: import('../types').TuitionPricing[] = [
  ...
  },
  {
    ...
    school_id: 'sch-ibime',
    level: 'preescolar',
    name: 'Preescolar Bilingüe IBIME',
    description: 'Planteles Montes, Lagos, San Cristóbal y Coacalco · Estimulación temprana, bilingüe Cambridge, psicomotricidad y artes.',
    monthly_fee: 3650.00,
    annual_inscription: 5200.00,
    materials_fee: 1400.00,
    due_day: 10
  },
  {
    ...
    school_id: 'sch-ibime',
    level: 'primaria',
    name: 'Primaria Bilingüe IBIME',
    description: 'Planteles Montes, Lagos, San Cristóbal y Coacalco · Currículo Oficial SEP NEM 2024, Cambridge English, Robótica STEAM y Aulas Digitales.',
    monthly_fee: 4250.00,
    annual_inscription: 5800.00,
    materials_fee: 1650.00,
    due_day: 10
  },
  {
    id: 'prc-ibime-sec',
    school_id: 'sch-ibime',
    level: 'secundaria',
    name: 'Secundaria Trilingüe IBIME',
    description: 'Planteles Montes, San Cristóbal y Coacalco · Certificaciones KET/PET Cambridge, Francés introductorio, laboratorios de ciencias y robótica.',
    monthly_fee: 4680.00,
    annual_inscription: 6200.00,
    materials_fee: 1850.00,
    due_day: 10
  },
  {
    id: 'prc-ibime-cch',
    school_id: 'sch-ibime',
    level: 'preparatoria',
    name: 'Bachillerato CCH UNAM IBIME',
    description: 'Planteles Montes y Coacalco · Plan Incorporado UNAM CCH (Clave 7998), propedéutico universitario, bilingüe avanzado y TOEFL/FCE.',
    monthly_fee: 5150.00,
    annual_inscription: 6800.00,
    materials_fee: 2100.00,
    due_day: 10
  }
];
...
export const BILLING_RECORDS_SEED: import('../types').FamilyBillingRecord[] = [
  ...
  // ==========================================
  // FACTURACIÓN Y COBRANZA INSTITUTO BILINGÜE IBIME
  // ==========================================
  {
    id: 'inv-ibime-001',
    school_id: 'sch-ibime',
    invoiceNumber: 'IBI-2026-00188',
    studentId: 'std-ibime-montes-01',
    parentName: 'Fernando Morales Soto',
    parentPhone: '5544401009',
    parentEmail: 'fernando.morales@ibime.edu.mx',
    studentName: 'Iker Santiago Morales Peña',
    level: 'Primaria',
    grade: '5º Primaria',
    group: '5ºA Primaria Bilingüe Montes',
    concept: 'Colegiatura de Septiembre 2026 · Bilingüe Cambridge',
    baseAmount: 4250.00,
    ...
    status: 'paid',
    autoInvoice: true,
    paidAt: '03 Septiembre 2026'
  },
  {
    id: 'inv-ibime-002',
    school_id: 'sch-ibime',
    invoiceNumber: 'IBI-2026-00189',
    studentId: 'std-ibime-lagos-01',
    parentName: 'Arturo Castillo Gómez',
    parentPhone: '5544401009',
    parentEmail: 'arturo.castillo@ibime.edu.mx',
    studentName: 'Ximena Valentina Castillo Ruiz',
    level: 'Primaria',
    grade: '3º Primaria',
    group: '3ºA Primaria Lagos',
    concept: 'Colegiatura de Septiembre 2026 · Campus Lagos',
    baseAmount: 4250.00,
    scholarshipPercentage: 0,
    amount: 4250.00,
    dueDate: '10 Septiembre 2026',
    status: 'paid',
    autoInvoice: true,
    paidAt: '05 Septiembre 2026'
  },
  {
    id: 'inv-ibime-003',
    school_id: 'sch-ibime',
    invoiceNumber: 'IBI-2026-00190',
    studentId: 'std-ibime-san-01',
    parentName: 'Carlos Navas Fuentes',
    parentPhone: '5544401009',
    parentEmail: 'carlos.navas@ibime.edu.mx',
    studentName: 'Mateo Emiliano Navas Mendoza',
    level: 'Secundaria',
    grade: '2º Secundaria',
    group: '2ºA Secundaria San Cristóbal',
    concept: 'Colegiatura de Septiembre 2026 · Secundaria Trilingüe',
    baseAmount: 4680.00,
    scholarshipPercentage: 20,
    scholarshipType: 'academica',
    discountAmount: 936.00,
    amount: 3744.00,
    dueDate: '10 Septiembre 2026',
    status: 'pending',
    autoInvoice: true
  },
  {
    id: 'inv-ibime-004',
    school_id: 'sch-ibime',
    invoiceNumber: 'IBI-2026-00191',
    studentId: 'std-ibime-coac-01',
    parentName: 'Manuel Albarrán Pineda',
    parentPhone: '5544401009',
    parentEmail: 'manuel.albarran@ibime.edu.mx',
    studentName: 'Regina Sofía Albarrán Cruz',
    level: 'Preparatoria',
    grade: '4º Semestre CCH',
    group: '4º Semestre CCH UNAM Coacalco',
    concept: 'Colegiatura de Septiembre 2026 · Bachillerato CCH UNAM',
    baseAmount: 5150.00,
    scholarshipPercentage: 25,
    scholarshipType: 'academica',
    discountAmount: 1287.50,
    amount: 3862.50,
    dueDate: '10 Septiembre 2026',
    status: 'paid',
    autoInvoice: true,
    paidAt: '01 Septiembre 2026'
  },
  {
    id: 'inv-ibime-005',
    school_id: 'sch-ibime',
    invoiceNumber: 'IBI-2026-00142',
    studentId: 'std-ibime-coac-02',
    parentName: 'Daniel Varela Luna',
    parentPhone: '5544401009',
    parentEmail: 'daniel.varela@ibime.edu.mx',
    studentName: 'Leonardo Daniel Varela Fuentes',
    level: 'Secundaria',
    grade: '1º Secundaria',
    group: '1ºA Secundaria Coacalco',
    concept: 'Colegiatura de Agosto 2026 (Extemporánea) · Coacalco',
    baseAmount: 4680.00,
    scholarshipPercentage: 0,
    amount: 4680.00,
    dueDate: '15 Agosto 2026',
...
export const INSTITUTIONS_SEED: import('../types').Institution[] = [
  {
    ...
    settings: {
      ...
      address: 'Calzada de los Filósofos 1712, Col. Del Valle, Ciudad de México',
      phone: '55-4160-8800',
      coordinators: ['Lic. Alejandro Valdés'],
      teachers: [],
      themeColors: {
        primary: '221 83% 53%',
        secondary: '268 85% 58%',
  ...
  },
  {
    ...
    settings: {
      ...
      teachers: [
        'Prof. Israel López Ángeles (Demo)',
        'Profa. María Fernández (Demo)',
        'Prof. Roberto Díaz (Demo)',
        'Profa. Carmen Morales (Demo)',
        'Prof. David Navarrete (Demo)',
        'Profa. Elena Salazar (Demo)',
        'Prof. Fernando Rangel (Demo)',
        'Prof. Alan Turing (Demo)',
        'Profa. Ada Lovelace (Demo)',
        'Prof. Carl Sagan (Demo)'
      ],
      themeColors: {
        primary: '280 84% 60%',
        secondary: '220 84% 54%',
  ...
  },
  {
    ...
    currency: 'MXN',
    licensing: {
      tier: 'Enterprise School Network',
    ...
    settings: {
      ...
      address: 'Av. Jardines de Morelos s/n, Sección Montes, C.P. 55070, Ecatepec de Morelos, Edomex',
      phone: '55-4440-1009',
      coordinators: ['Dirección General IBIME', 'Coordinación Académica Cambridge'],
      teachers: [
        'Prof. Roberto González (Montes CCH)',
        'Profa. Patricia Salmerón (Lagos Primaria)',
        'Prof. Andrés Morales (San Cristóbal Secundaria)',
  ...
  {
    id: 'sch-profesores-independientes',
    name: 'Profesores Independientes',
    tagline: 'Red de Docentes Autónomos y Creadores Curriculares ISkool',
    cct: '09INDEP2026I',
    logoUrl: '',
    isTestCase: false,
    isIndependentTeachersNetwork: true,
    status: 'active',
    createdAt: '2026-03-01T08:00:00.000Z',
    address: 'Comunidad Nacional de Docentes Autónomos, México',
    phone: '55-8000-DOCENTE',
    website: 'https://independientes.iskool.edu.mx',
    coordinatorName: 'Supervisión Central de Inteligencia Artificial Pedagógica',
    campusesCount: 1,
    studentsCount: 8,
    teachersCount: 2,
    aiTokensConsumed: 124500,
    currency: 'MXN',
    settings: {
      isConfigured: true,
      name: 'Profesores Independientes',
      ...
      address: 'Comunidad Nacional de Docentes Autónomos, México',
      phone: '55-8000-DOCENTE',
      coordinators: ['Supervisión Central ISkool'],
      teachers: ['Prof. Gabriel Montes (Independiente)', 'Profa. Sofía Albarrán (Independiente)'],
      themeColors: {
        primary: '262 83% 58%',   // Violeta Eléctrico Pedagógico
        secondary: '190 90% 50%', // Cian Neón
...
export const DEFAULT_DIRECTOR_LIMITS: import('../types').DirectorLimitsSettings = {
  canManageCampuses: false,
  canModifyTuitionFees: false,
  canRegisterCoordinators: true,
  canPurgeCurricularVault: false,
  maxScholarshipDiscountPercent: 50
};

export const DEFAULT_GOVERNANCE_SETTINGS: import('../types').SchoolGovernanceSettings = {
  allowCoordinatorBilling: true,
  allowCoordinatorDelete: false,
  allowTeacherGradeEditing: true,
  allowStudentGamification: true,
  allowAiAssistantTeachers: true,
  allowAiAssistantStudents: true,
  restrictParentContactForTeachers: false,
  requirePlanningApproval: false,
  restrictedTopics: [
    {
      id: 'top-restr-01',
      topicTitle: 'Educación Financiera Avanzada y Criptoactivos',
      subjectName: 'Matemáticas y Finanzas',
      grade: 'Secundaria (2º)',
      reason: 'Requiere revisión directiva previa y enfoque regulatorio para nivel básico.',
      restrictedAt: '2026-08-15T10:00:00Z',
...
export const STAFF_USERS_SEED: import('../types').UserProfile[] = [
  {
    ...
    last_name: 'Vargas Robles',
    role: 'owner',
    email: 'dueno@jjrosseau.edu.mx',
    phone: '55-1234-5678',
    campus_name: 'Dirección Corporativa & Presidencia',
  ...
  },
  {
    ...
    school_id: 'sch-jjrosseau',
    first_name: 'Roberto',
    last_name: 'Garza Hernández',
    role: 'director',
    email: 'director@jjrosseau.edu.mx',
    phone: '55-4160-8801',
  ...
  },
  {
    ...
    role: 'director',
    email: 'director@laboratoriopedagogico.edu.mx',
    phone: '55-8000-8801',
    campus_name: 'Dirección General Sandbox',
    temporary_password: 'DIR880',
  ...
  },
  {
    ...
    last_name: 'Morales',
    role: 'coordinator',
    email: 'coordinacion@laboratoriopedagogico.edu.mx',
    phone: '55-8000-8802',
    campus_name: 'Coordinación Académica',
  ...
  },
  {
    ...
    last_name: 'Valdés',
    role: 'coordinator',
    email: 'alejandro.valdes@jjrosseau.edu.mx',
    phone: '55-4160-8802',
    campus_name: 'Coordinación UP',
    temporary_password: 'CRD123',
    created_at: '2026-01-20T08:00:00.000Z',
    updated_at: '2026-01-20T08:00:00.000Z'
  },
  {
    ...
    school_id: 'sch-test-case',
    first_name: 'Mónica',
    last_name: 'Suárez Pérez',
    role: 'billing',
    email: 'cobranza@laboratoriopedagogico.edu.mx',
    phone: '55-8000-8803',
    campus_name: 'Departamento de Cobranza y Finanzas',
  ...
  },
  {
    ...
    school_id: 'sch-jjrosseau',
    first_name: 'Estela',
    last_name: 'Gutiérrez Nava',
    role: 'billing',
    email: 'cobranza@jjrosseau.edu.mx',
    phone: '55-4160-8803',
    campus_name: 'Finanzas y Tesorería UP',
    temporary_password: 'COB880',
    created_at: '2026-01-20T08:00:00.000Z',
    updated_at: '2026-01-20T08:00:00.000Z'
  },

  // ==========================================
  // DIRECTIVOS Y ADMINISTRATIVOS IBIME
  // ==========================================
  {
    id: 'usr-owner-ibime',
    school_id: 'sch-ibime',
    first_name: 'Don Guillermo',
    last_name: 'Valdés Montes',
    role: 'owner',
...
export const STAFF_PAYROLL_SEED: StaffPayrollRecord[] = [
  // 1. Plantel UP Juan Jacobo Rosseau (sch-jjrosseau)
  {
    id: 'pay-jjr-001',
    employee_id: 'usr-dir-1',
    employee_name: 'Roberto Garza Hernández',
    role: 'director',
    department: 'Dirección General de Plantel',
    position_title: 'Director General de Plantel',
    school_id: 'sch-jjrosseau',
    campus_name: 'Dirección General de Plantel',
    base_salary: 38500.00,
    bonuses: 4000.00,
    deductions: 5800.00,
    net_salary: 36700.00,
    payment_period: '1ª Quincena Septiembre 2026',
    period_type: 'quincenal',
    payment_date: '2026-09-01T10:30:00.000Z',
    status: 'pagado',
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'BBVA México',
    account_clabe: '012180004567891234',
    rfc: 'GAHR780415-K89',
    curp: 'GAHR780415HDFRRN02',
    receipt_folio: 'REC-NOM-2026-0901',
    notes: 'Bono directivo por cumplimiento de metas de retención institucional.'
  },
  {
    id: 'pay-jjr-002',
    employee_id: 'usr-coord-jjr',
    employee_name: 'Alejandro Valdés',
    role: 'coordinator',
    department: 'Coordinación Académica',
    position_title: 'Coordinador Académico General',
    school_id: 'sch-jjrosseau',
    campus_name: 'Coordinación UP',
    ...
    payment_period: '1ª Quincena Septiembre 2026',
    period_type: 'quincenal',
    payment_date: '2026-09-01T10:35:00.000Z',
    status: 'pagado',
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'Santander',
    account_clabe: '014180556789123456',
    rfc: 'VAEL820912-MN3',
    curp: 'VAEL820912HDFLLD05',
    receipt_folio: 'REC-NOM-2026-0902',
    notes: 'Incentivo por homologación y auditoría de la Bóveda Curricular.'
  },
  {
    id: 'pay-jjr-003',
    employee_id: 'tch-jjr-maria',
    employee_name: 'María Fernández Soto',
    role: 'teacher',
    department: 'Cuerpo Docente',
    position_title: 'Profesora Titular de Primaria',
    school_id: 'sch-jjrosseau',
    campus_name: 'Primaria Jardines',
    base_salary: 21500.00,
    bonuses: 2000.00,
    deductions: 2800.00,
    net_salary: 20700.00,
    payment_period: '1ª Quincena Septiembre 2026',
    period_type: 'quincenal',
    payment_date: '2026-09-01T10:40:00.000Z',
    status: 'pagado',
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'Banamex',
    account_clabe: '002180701234567890',
    rfc: 'FESM851020-A21',
    curp: 'FESM851020MDFRRT09',
    receipt_folio: 'REC-NOM-2026-0903',
    notes: 'Bono pedagógico por planeaciones destacadas NEM 2024.'
  },
  {
    id: 'pay-jjr-004',
    employee_id: 'tch-jjr-israel',
    employee_name: 'Israel López Ángeles',
    role: 'teacher',
    department: 'Cuerpo Docente',
    position_title: 'Profesor Titular de Primaria',
    school_id: 'sch-jjrosseau',
    campus_name: 'Primaria Torres',
    base_salary: 21500.00,
    bonuses: 2000.00,
    ...
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'Banorte',
    account_clabe: '072180002345678901',
    rfc: 'LOAI840311-BC4',
    curp: 'LOAI840311HDFRRN04',
    notes: 'Pendiente de dispersión quincenal regular.'
  },
  {
    id: 'pay-jjr-005',
    employee_id: 'usr-billing-jjr',
    employee_name: 'Estela Gutiérrez Nava',
    role: 'billing',
    department: 'Cobranza y Finanzas',
    position_title: 'Jefa de Cobranza y Finanzas',
    school_id: 'sch-jjrosseau',
    campus_name: 'Finanzas y Tesorería UP',
    ...
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'HSBC',
    account_clabe: '021180045678901234',
    rfc: 'GUNE880506-TX9',
    curp: 'GUNE880506MDFRRN08',
    notes: 'Bono por meta de recuperación oportuna de colegiaturas.'
  },
  {
    id: 'pay-jjr-006',
    employee_id: 'tch-jjr-carmen',
    employee_name: 'Carmen Salazar Vega',
    role: 'teacher',
    department: 'Cuerpo Docente',
    position_title: 'Docente Titular de Ciencias',
    school_id: 'sch-jjrosseau',
    campus_name: 'Secundaria Torres',
    ...
    payment_period: '1ª Quincena Septiembre 2026',
    period_type: 'quincenal',
    status: 'en_dispersion',
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'BBVA México',
    account_clabe: '012180009876543210',
    rfc: 'SAVC860714-LM8',
    curp: 'SAVC860714MDFRRV06',
    notes: 'Lote de dispersión en proceso con intermediario bancario.'
  },
  {
    id: 'pay-jjr-007',
    employee_id: 'tch-jjr-ricardo',
    employee_name: 'Ricardo Gómez Morales',
    role: 'teacher',
    department: 'Cuerpo Docente',
    position_title: 'Docente Titular de Matemáticas',
    school_id: 'sch-jjrosseau',
    campus_name: 'Secundaria Torres',
    base_salary: 20000.00,
    bonuses: 1500.00,
    ...
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'Santander',
    account_clabe: '014180987654321098',
    rfc: 'GOMR831128-PX5',
    curp: 'GOMR831128HDFLLP03',
    notes: 'Lote de dispersión en proceso con intermediario bancario.'
  },

  // 2. Plantel Laboratorio Pedagógico Demo (sch-test-case)
  {
    id: 'pay-demo-001',
    employee_id: 'usr-dir-test',
    employee_name: 'Carlos Mendoza Ruiz',
    role: 'director',
    department: 'Dirección General de Plantel',
    position_title: 'Director General Sandbox',
    school_id: 'sch-test-case',
    campus_name: 'Dirección General Sandbox',
    base_salary: 36000.00,
    bonuses: 3500.00,
    deductions: 5200.00,
    net_salary: 34300.00,
    payment_period: '1ª Quincena Septiembre 2026',
    period_type: 'quincenal',
    payment_date: '2026-09-01T11:00:00.000Z',
    status: 'pagado',
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'BBVA México',
    account_clabe: '012180001122334455',
    rfc: 'MERC800202-AA1',
    curp: 'MERC800202HDFRRN01',
    receipt_folio: 'REC-NOM-TEST-0901',
    notes: 'Nómina directiva quincenal.'
  },
  {
    id: 'pay-demo-002',
    employee_id: 'usr-coord-1',
    employee_name: 'Beatriz Morales',
    role: 'coordinator',
    department: 'Coordinación Académica',
    position_title: 'Coordinadora Académica Demo',
    school_id: 'sch-test-case',
    campus_name: 'Coordinación Académica',
    ...
    payment_period: '1ª Quincena Septiembre 2026',
    period_type: 'quincenal',
    payment_date: '2026-09-01T11:05:00.000Z',
    status: 'pagado',
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'Santander',
    account_clabe: '014180112233445566',
    rfc: 'MOBB840510-BB2',
    curp: 'MOBB840510MDFLLD02',
    receipt_folio: 'REC-NOM-TEST-0902',
    notes: 'Nómina quincenal coordinada.'
  },
  {
    id: 'pay-demo-003',
    employee_id: 'usr-billing-1',
    employee_name: 'Mónica Suárez Pérez',
    role: 'billing',
    department: 'Cobranza y Finanzas',
    position_title: 'Encargada de Cobranza Sandbox',
    school_id: 'sch-test-case',
    campus_name: 'Departamento de Cobranza y Finanzas',
    ...
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'Banorte',
    account_clabe: '072180112233445577',
    rfc: 'SUPM890315-CC3',
    curp: 'SUPM890315MDFRRN03',
    notes: 'En espera de visto bueno contable.'
  },
  {
    id: 'pay-demo-004',
    employee_id: 'prof-1',
    ...
    role: 'teacher',
    department: 'Cuerpo Docente',
    position_title: 'Profesor Titular Demo',
    school_id: 'sch-test-case',
    campus_name: 'Primaria Laboratorio Demo',
    ...
    payment_period: '1ª Quincena Septiembre 2026',
    period_type: 'quincenal',
    payment_date: '2026-09-01T11:15:00.000Z',
    status: 'pagado',
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'Banamex',
    account_clabe: '002180112233445588',
    rfc: 'GORB850619-DD4',
    curp: 'GORB850619HDFRRT04',
    receipt_folio: 'REC-NOM-TEST-0904',
    notes: 'Pago regular quincenal con bono docente.'
  },

  // 3. Instituto Bilingüe IBIME (sch-ibime)
  {
    id: 'pay-ibime-001',
    employee_id: 'usr-dir-ibime-montes',
    employee_name: 'Patricia Sandoval Morales',
    role: 'director',
    department: 'Dirección General de Plantel',
    position_title: 'Directora General & Campus Montes',
    school_id: 'sch-ibime',
    campus_name: 'Campus Montes (Sede Matriz & CCH)',
    base_salary: 44000.00,
    bonuses: 5000.00,
    deductions: 7000.00,
    net_salary: 42000.00,
    payment_period: '1ª Quincena Septiembre 2026',
    period_type: 'quincenal',
    payment_date: '2026-09-01T10:00:00.000Z',
    status: 'pagado',
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'BBVA México',
    account_clabe: '012180009988776655',
    rfc: 'SAMP780512-IB1',
    curp: 'SAMP780512MDFRL01',
    receipt_folio: 'REC-NOM-IBIME-0901',
    notes: 'Bono institucional por acreditación de estándares CCH UNAM y SEP NEM.'
  },
  {
    id: 'pay-ibime-002',
    employee_id: 'usr-coord-ibime',
    employee_name: 'Marco Antonio Ruiz Peralta',
    role: 'coordinator',
    department: 'Coordinación Académica & Enlace CCH',
    position_title: 'Coordinador Académico Bilingüe',
    school_id: 'sch-ibime',
    campus_name: 'Coordinación Académica & Enlace CCH',
    ...
    payment_period: '1ª Quincena Septiembre 2026',
    period_type: 'quincenal',
    payment_date: '2026-09-01T10:15:00.000Z',
    status: 'pagado',
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'Banorte',
    account_clabe: '072180009988776644',
    rfc: 'RUPM820719-IB2',
    curp: 'RUPM820719HDFRL02',
    receipt_folio: 'REC-NOM-IBIME-0902',
    notes: 'Bono por supervisión curricular en los 4 planteles IBIME.'
  },
  {
    id: 'pay-ibime-003',
    employee_id: 'usr-billing-ibime',
    employee_name: 'Mariana Rivas Corona',
    role: 'billing',
    department: 'Tesorería & Facturación CFDI 4.0',
    position_title: 'Jefa de Finanzas y Cobranza IBIME',
    school_id: 'sch-ibime',
    campus_name: 'Tesorería & Facturación CFDI 4.0',
    ...
    payment_period: '1ª Quincena Septiembre 2026',
    period_type: 'quincenal',
    payment_date: '2026-09-01T10:20:00.000Z',
    status: 'pagado',
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'Santander',
    account_clabe: '014180009988776633',
    rfc: 'RICM880925-IB3',
    curp: 'RICM880925MDFRL03',
    receipt_folio: 'REC-NOM-IBIME-0903',
    notes: 'Bono por meta de timbrado masivo CFDI 4.0 con complemento IEDU SAT.'
  },
  {
    id: 'pay-ibime-004',
    employee_id: 'usr-teacher-ibime-1',
    employee_name: 'Alejandro Mendoza Peña',
    role: 'teacher',
    department: 'Cuerpo Docente CCH',
    position_title: 'Profesor Titular CCH UNAM & Robótica',
    school_id: 'sch-ibime',
    campus_name: 'Campus Montes (Sede Matriz & CCH)',
    ...
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'BBVA México',
    account_clabe: '012180009988776622',
    rfc: 'MEPA840618-IB4',
    curp: 'MEPA840618HDFRL04',
    receipt_folio: 'REC-NOM-IBIME-0904',
    notes: 'Pago regular con estímulo de docencia STEAM.'
  },
  {
    id: 'pay-ibime-005',
    employee_id: 'usr-teacher-ibime-2',
    employee_name: 'Elizabeth Hernández Ramos',
    role: 'teacher',
    department: 'Cuerpo Docente Bilingüe',
    position_title: 'Docente Cambridge English Specialist',
    school_id: 'sch-ibime',
    campus_name: 'Campus Lagos (Fundador 2004)',
    ...
    payment_method: 'SPEI / Transferencia Bancaria',
    bank_name: 'Banorte',
    account_clabe: '072180009988776611',
    rfc: 'HERE891124-IB5',
    curp: 'HERE891124MDFRL05',
    notes: 'En proceso de validación bancaria quincenal.'
  }
];
